    ...
    return (
        <div className="flex flex-col gap-12 animate-in fade-in slide-in-from-bottom-4 duration-500">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {data.user_rejection_triggers.map((trigger, i) => (
                        <BorderedCard className="flex flex-col">
                            <div key={i} className="bg-destructive/5 flex-1 border border-destructive/10 p-5 md:p-8 rounded-3xl md:rounded-4xl flex flex-col gap-4 relative overflow-hidden group hover:border-destructive/30 transition-all duration-300">
            ...
            <section className="flex flex-col gap-6">
                ...
                <div className="grid grid-cols-1 gap-6">
                    {data.exploitable_ambiguities.map((amb, i) => (
                        <BorderedCard className="flex flex-col">
                            <div key={i} className="bg-card flex-1 border border-border p-5 md:p-8 rounded-3xl md:rounded-4xl grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-10 items-center shadow-sm hover:border-primary/20 transition-all duration-300">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                <BorderedCard className="flex flex-col">
                    <div className="bg-card flex-1 border border-border p-6 md:p-10 rounded-3xl md:rounded-4xl shadow-sm">
