                ...
                <section className="flex flex-col gap-6">
                    ...
                    <div className="flex flex-col gap-4">
                        {data.unscoped.map((item, i) => (
                            <div key={i} className="bg-card border border-border p-6 rounded-2xl shadow-sm hover:border-destructive/30 transition-colors">
                    ...
                    {!data.scoped ? (
                        ...
                        <div className="flex flex-col gap-4">
                            {data.scope.map((item, i) => (
                                <div key={i} className="bg-card border border-border p-6 rounded-2xl shadow-sm hover:border-green-500/30 transition-colors group">
