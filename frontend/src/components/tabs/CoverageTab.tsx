...
const CoverageTab = ({ data }: CoverageTabProps) => {
    ...
    return (
        <div className="flex flex-col gap-10 animate-in fade-in slide-in-from-bottom-4 duration-500">
            {/* Disease Section */}
            <BorderedCard>
                <section className="bg-card border border-border shadow-sm rounded-3xl overflow-hidden shadow-sm">
                    <div className="p-6 border-b border-border bg-muted/10 flex items-center gap-4">
                        ...
                        <h3 className="text-2xl font-bold text-foreground">Disease Coverage</h3>
                    </div>
                    ...
                    <div className="p-6 md:p-8">
                        {!desease.mention ? (
                            ...
                            <div className="flex flex-col gap-8">
                                {/* Cover All Check */}
                                <div className={`p-6 rounded-2xl border transition-all duration-300 ${desease.cover_all.bool ? 'bg-green-500/5 border-green-500/20' : 'bg-destructive/5 border-destructive/20'}`}>
                                    <div className="flex items-center gap-4 mb-4">
                                        <div className={`w-3 h-3 rounded-full animate-pulse ${desease.cover_all.bool ? 'bg-green-500' : 'bg-destructive'}`} />
                                        <span className={`text-xl font-bold ${desease.cover_all.bool ? 'text-green-500' : 'text-destructive'}`}>
            ...
            <BorderedCard>
                <section className="bg-card border border-border shadow-sm rounded-3xl overflow-hidden shadow-sm">
                    <div className="p-6 border-b border-border bg-muted/10 flex items-center gap-4">
                        ...
                        <h3 className="text-2xl font-bold text-foreground">Hospital Network</h3>
                    </div>
                    ...
                    <div className="p-6 md:p-8">
                        {!hospital.mention ? (
                            ...
                            <div className="flex flex-col gap-8">
                                <div className={`p-6 rounded-2xl border transition-all duration-300 ${hospital.cover_all.bool ? 'bg-green-500/5 border-green-500/20' : 'bg-primary/5 border-primary/20'}`}>
                                    <div className="flex items-center gap-4 mb-4">
                                        <div className={`w-3 h-3 rounded-full animate-pulse ${hospital.cover_all.bool ? 'bg-green-500' : 'bg-primary'}`} />
                                        <span className={`text-xl font-bold ${hospital.cover_all.bool ? 'text-green-500' : 'text-primary'}`}>
