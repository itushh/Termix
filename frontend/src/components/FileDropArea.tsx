...
const FileDropArea = ({ onAnalysisComplete, onSummaryChunk, onStarted }: FileDropAreaProps) => {
    ...
    return (
        <>
        <BorderedCard className='flex-1 flex flex-col mt-10'>
        ...
        {/* <BorderedCard className='w-fit mx-auto'> */}
            <div className="text-sm text-muted-foreground/60 flex items-center gap-0 justify-center pb-10">
